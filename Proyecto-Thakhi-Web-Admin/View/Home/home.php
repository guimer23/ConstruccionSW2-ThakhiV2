<?php include ('View/Layout/encabezado.php'); ?>
            ...
            <div class="menu-body slimscroll">
                ...
                <div id="Mantenimiento" class="main-icon-menu-pane">
                    ...
                    <ul class="nav in mm-show">
                        <li class="nav-item"><a class="nav-link" href="Views/admClsVehiculo/admFrmListar.php"><i
                                    class="mdi mdi-car-multiple"></i>Vehículos</a></li>
                        <li class="nav-item"><a class="nav-link" href="Views/admClsConductor/admFrmListar.php"><i
                        ...
                        <li class="nav-item"><a class="nav-link" href="Views/admClsCliente/admFrmListar.php"><i
                                    class="mdi mdi-account-multiple"></i>Clientes</a></li>
                        <li class="nav-item"><a class="nav-link" href="Views/admClsUsuario/admFrmListar.php"><i
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mt-0">Reporte por Meses</h4>
                            <div class="">
                            ...
                            <div class="row">
                                <div class="col-8 align-self-center">
                                    <div class="impressions-data">
                                        ...
                                        <h2 class="mt-0">140k <span class="text-success  font-12 font-weight-normal"><i
...
<?php include ('View/Layout/pie.php'); ?>